...
public class MultiTimestepRegressionExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .learningRate(0.01)
                .list()
                .layer(0, new GravesLSTM.Builder().activation(Activation.TANH).nIn(numOfVariables).nOut(30)
                        .build())
                .layer(1, new GravesLSTM.Builder().activation(Activation.TANH).nIn(30).nOut(20)
                        .build())
                .layer(2, new DenseLayer.Builder().nIn(20).nOut(20)
                        .activation(Activation.TANH)
                        .build())
                .layer(3, new RnnOutputLayer.Builder(LossFunctions.LossFunction.MSE)
                        .activation(Activation.IDENTITY).nIn(20).nOut(numOfVariables).build())
                .build();
...
//            System.out.println(evaluation.stats());
    ...
    private static List<String> prepareTrainAndTest(int trainSize, int testSize, int numberOfTimesteps) throws IOException {
        Path rawPath = Paths.get(baseDir.getAbsolutePath() + "/dataset.csv");
